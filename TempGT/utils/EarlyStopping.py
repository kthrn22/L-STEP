...
class EarlyStopping(object):
    ...
    def __init__(self, patience: int, save_model_folder: str, save_model_name: str, logger: logging.Logger, save_trained_pe: str = "no PE if not TempGT", model_name: str = None):
        """
        Early stop strategy.
    ...
    def step(self, metrics: list, model: nn.Module, final_trained_positional_encoding = None):
        """
