...
def get_link_prediction_args(is_evaluation: bool = False):
    ...
    parser.add_argument('--model_name', type=str, default='DyGFormer', help='name of the model, note that EdgeBank is only applicable for evaluation',
                        choices=['JODIE', 'TempGT', 'DyRep', 'TGAT', 'TGN', 'CAWN', 'EdgeBank', 'TCL', 'GraphMixer', 'DyGFormer'])
    ...
    parser.add_argument('--pe_weight', type=float, default=0.3, help = 'weight for positional encoding loss')
    parser.add_argument('--neg_sample_weight', type=float, default=0.1, help='weight of negative links in positional encoding loss')
